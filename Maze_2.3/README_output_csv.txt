COUNT, DEPTH, LEFT CUE, CENTRE CUE, RIGHT CUE, LQUANTITY, LIMAGE, LPROBS, CQUANTITY, CIMAGE, CPROBS, RQUANTITY, RIMAGE, RPROBS, CHASING CUE, CHOICE, DIRECTION, INVENTORY0, INVENTORY1, INVENTORY2, PRIZE0, PRIZE1, PRIZE2, DEC0, DEC1, DEC2
.
.
.
--------------------------------------------------
...
LQUANTITY...RPROBS are the possible quantities for each prize, the image file and the list of probabilities associated with the left, centre and right cues respectively.
