'''This class is used to keep track of the "location" of the camera. 
...
class Camera:
	...
	def __init__(self, width, height):
		...
		self.display = (width, height)	#Window size
		pygame.display.set_icon(pygame.image.load(ICON_FILE))
		self.screen = pygame.display.set_mode(self.display, DOUBLEBUF|OPENGL)
		pygame.display.set_caption(TITLE)
		
		gluPerspective(45, (self.display[0]/self.display[1]), .2, 50.0)	#Set up GL
		#camera.advance(-10)	
